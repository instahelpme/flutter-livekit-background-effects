...
import me.instahelp.livekit_background_effects_native.shader.CONSTANT_VERTEX_SHADER_SOURCE
import me.instahelp.livekit_background_effects_native.shader.FULL_RECTANGLE_BUFFER
import me.instahelp.livekit_background_effects_native.shader.FULL_RECTANGLE_TEXTURE_BUFFER
import me.instahelp.livekit_background_effects_native.shader.ShaderUtil
import me.instahelp.livekit_background_effects_native.shader.VERTEX_SHADER_POS_COORD_NAME
...
internal data class BlurShader(
    ...
    fun applyBlur(
        ...
        val texelWidth: Float
        val texelHeight: Float
        if (rotation % 180 == 0) {
            texelWidth = 1.0f / viewportWidth
            texelHeight = 1.0f / viewportHeight
        } else {
            texelWidth = 1.0f / viewportHeight
            texelHeight = 1.0f / viewportWidth
        }
